<?php $__env->startSection('content'); ?>
    ...
    <section class="about" id="about">
        <div class="container text-center">
            <div class="row ">
                <div class="col ">
                    <img src="<?php echo e(asset('img/leospa-icon.png')); ?>" class="img-fluid" alt="">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col col-6 col-md-3 ">
                    <div>
                        <img src="<?php echo e(asset('img/features/leospa-modern-style.png')); ?>" class="img-fluid" alt="">
                        <div class="overlay">
                            <img src="<?php echo e(asset('img/features/icon.png')); ?>" class="img-fluid" alt="">
                ...
                <div class="col col-6 col-md-3 ">
                    <div>
                        <img src="<?php echo e(asset('img/features/leospa-body-treatment.png')); ?>" class="img-fluid" alt="">
                        <div class="overlay">
                            <img src="<?php echo e(asset('img/features/icon.png')); ?>" class="img-fluid" alt="">
                ...
                <div class="col col-6 col-md-3 ">
                    <div>
                        <img src="<?php echo e(asset('img/features/leospa-best-places.png')); ?>" class="img-fluid" alt="">
                        <div class="overlay">
                            <img src="<?php echo e(asset('img/features/icon.png')); ?>" class="img-fluid" alt="">
                ...
                <div class="col col-6 col-md-3 ">
                    <div>
                        <img src="<?php echo e(asset('img/features/leospa-expert-staff.png')); ?>" class="img-fluid" alt="">
                        <div class="overlay">
                            <img src="<?php echo e(asset('img/features/icon.png')); ?>" class="img-fluid" alt="">
            ...
            <div class="row justify-content-md-center">
                <div class="col col-xxl-auto">
                    <div class="service-box">
                        <img src="<?php echo e(asset('img/services/leospa-message-theraphy.png')); ?>" class="img-fluid" alt="">
    ...
    <section class="team" id="team">
        <div class="container text-center">
            ...
            <div class="row justify-content-md-center">
                <div class="col col-xxl-auto">
                    <div class="team-box">
                        <img src="<?php echo e(asset('img/team/leospa-austin.png')); ?>" class="img-fluid" alt="">
                        <div class="info">
                ...
                <div class="col col-xxl-auto">
                    <div class="team-box">
                        <img src="<?php echo e(asset('img/team/leospa-david.png')); ?>" class="img-fluid" alt="">
                        <div class="info">
                            <h3>David Hannan</h3>
                            <p>Thai Message</p>
                            <div class="social">
                ...
                <div class="col col-xxl-auto">
                    <div class="team-box">
                        <img src="<?php echo e(asset('img/team/leospa-cherly.png')); ?>" class="img-fluid" alt="">
                        <div class="info">
                            <h3>Cheryl Harris</h3>
                            <p>Thai Message</p>
                            <div class="social">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-7 col-sm-12 appointment-form">
                    <form action="<?php echo e(route('site.appointment.form')); ?>" method="post">
                        <?php echo csrf_field(); ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-5 col-sm-12 contact-info">
                    <div class="row">
                        <div class="col-2 info-box">
                            <div class="icon">
                                <img src="<?php echo e(asset('img/icons/map.svg')); ?>" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-2 info-box">
                            <div class="icon">
                                <img src="<?php echo e(asset('img/icons/email.svg')); ?>" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-2 info-box">
                            <div class="icon">
                                <img src="<?php echo e(asset('img/icons/tablet.svg')); ?>" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-xl-7 col-sm-12 contact-form">
                    <form action="<?php echo e(route('site.contact.form')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('site.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/full-stack-challenge/resources/views/site/pages/home.blade.php ENDPATH**/ ?>